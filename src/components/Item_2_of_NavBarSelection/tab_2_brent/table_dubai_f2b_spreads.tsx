...
export const Table_dubai_f2b_spreads_with_button = () => {
    ...
    <>
      ...
      <div >
        <div className="flex-grow">
          <Table_template_2 mockData={tableData} onUpdateData={handleUpdateData} columns={columns} table={table} table_name="Dubai F2B Spreads"/> 
        </div>
